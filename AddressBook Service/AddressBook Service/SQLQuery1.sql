...
AS BEGIN
INSERT INTO AddressBookTable VALUES(@FirstName,@LastName,@Address,@City,@State,@Zip,@MobNo,@Email,@Type,@AddressBookName)
END
SELECT * FROM AddressBookTable

UPDATE AddressBookTable SET Type='Novel' WHERE FirstName='Satyajeet'
SELECT * FROM AddressBookTable
UPDATE AddressBookTable SET AddressBookName='ABC' WHERE FirstName='Satyajeet'
SELECT * FROM AddressBookTable
...
AS BEGIN
UPDATE AddressBookTable SET Address=@Address,MobNo=@MobNo WHERE FirstName=@FirstName
END
SELECT * FROM AddressBookTable
